...
describe ExcelAbstraction::Time do
  context "when date is before REFERENCE date" do
    subject { described_class.new("1900-01-01 00:00 +00:00".to_time) }
  ...
  context "when date is after REFERENCE date" do
    subject { described_class.new("2000-01-19 12:00".to_time) }
  ...
  describe "#to_excel_time" do
    subject { described_class.new("2012-01-23 14:00".to_time) }
